...
public class ServerActivity extends Activity{
    ...
    private void exit() {
        new AlertDialog.Builder(ServerActivity.this).setTitle(getResources().getString(R.string.warningTitle)).setMessage(getResources().getString(R.string.warningMsg)).setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
            @Override
